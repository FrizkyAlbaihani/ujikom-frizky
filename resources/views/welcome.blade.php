                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto">
                            <li>
                                <div class="sidebar-brand" ><h1>Laundry</h1></div>
                            </li>
                        </ul>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex justify-content-left">
                                        <form action="{{ route('welcome') }}" method="GET" class="mb-3" id="searchForm">
                                            <div class="input-group">
                                                <input type="text" name="search" id="search" class="form-control" placeholder="Cari Orderan..." value="{{ $request->filled('search') ? $request->search : '' }}">
                                            </div>
                                        </form>
                                    </div>
